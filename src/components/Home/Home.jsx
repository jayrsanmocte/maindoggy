        ...
        <div className="container">
            <section>
                <div className="Interesting py-3">
                    <p> Fascinating Facts  <span style={{color:'rgba(252,176,66,255)'}}>About Dogs</span></p>
                </div>
                <div className="row">
                    ...
                    <div className='col-4'>
                        ...
                        <p className='text-center'>The English Mastiff, originating from England, is recognized as one of the largest dog breeds globally. It can weigh up to 200 pounds and stand at an impressive height.</p>
                    </div>
                    ...
                    <div className="target">
                        ...
                        <p className='text-center'>The Greyhound, with its sleek physique, is widely recognized as one of the fastest dog breeds globally. It can reach speeds of up to 45 miles per hour.</p>
                    </div>
                    <div className='col-4'>
                    <div className="target">
                        <div className='interestingIconsBox pt-5'>
                        ...
                        <span className='trivia py-4'><span style={{color: 'rgba(252,176,66,255)'}}>Sweetest &nbsp;</span>Dogs</span>
                        <p className='text-center'>Bichon Frise: Bichon Frises are charming and affectionate companions. They love being the center of attention and are known for their cheerful and loving nature.</p>
                    </div>
                   </div>
                   ...
                   <div className="row">
                    ...
                    <div className="target">
                        ...
                        <p className='text-center'>The Golden Retriever, known for its friendly and gentle nature, is often considered one of the most morally exceptional breeds, displaying loyalty and compassion.</p>
                    </div>
                    <div className='col-4'>
                    <div className="target">
                        <div className='interestingIconsBox pt-5'>
                        ...
                        <p className='text-center'>The Chihuahua, native to Mexico, is one of the smallest dog breeds worldwide, often weighing just a few pounds and standing a mere few inches tall.</p>
                    </div>
                    <div className='col-4'>
                    <div className="target">
                        <div className='interestingIconsBox pt-5'>
                        ...
                        <p className='text-center'>The American Pit Bull Terrier, known for its strength and determination, has impressive muscular power and endurance.</p>
                    </div>
                </div>
            </section>
        </div>
